Repository for my BA thesis focusing on hate speech detection. The goal is to create an automatic tool that detects hateful text english, spanish and greek.
